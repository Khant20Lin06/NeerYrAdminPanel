...
const BusinessCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(EndPoint.BUSINESSES_CREATE, data, {
        headers: {
      ...
      <Box sx={{ display: "flex", justifyContent: "center", mt: 5 }}>
        <Paper elevation={3} sx={{ p: 4, width: 560 }}>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            {/* ✅ Paid until (screenshot-like panel) */}
            <Box
              sx={{
                mt: 1,
                p: 2,
            ...
            >
              ...
              <Stack spacing={1.2}>
                <Stack direction="row" spacing={1.5} alignItems="center" flexWrap="wrap">
                  ...
                  />
                  <Button variant="text" onClick={setToday} sx={{ color: "#7dd3fc" }}>
                    Today
                  </Button>
                </Stack>
                ...
                <Stack direction="row" spacing={1.5} alignItems="center" flexWrap="wrap">
                  ...
                  <TextField
                    ...
                    InputLabelProps={{ shrink: true }}
                  />
                  <Button variant="text" onClick={setNow} sx={{ color: "#7dd3fc" }}>
                    Now
                  </Button>
                </Stack>
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              <Stack spacing={1} alignItems="center">
                ...
                <Avatar src={logoPreview || PLACEHOLDER} variant="rounded" sx={{ width: 110, height: 110, boxShadow: 2 }} />
